  ...
  <div class="box">
        ...
        <div class="box-body collapse">
          Esta seccion se realiza la generacion de tickets de servicio los cuales seran cubiertos por la empresa, para ello debe rellenar todas las casillas solicitadas, la cual generar un TICKET DE CONTROL, por el cual podra realizar seguimiento al traslado realizado hasta despues de su cancelacion.
        </div>
        <!-- /.box-body -->
