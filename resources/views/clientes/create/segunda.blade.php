        ...
        ====================================================-->
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
              ...
              <div class="form-group">
                ...
                {!! Form::text('nameCli', null, ['class'=>'form-control', 'placeholder'=>'Ingrese el nombre']) !!}
              </div>
              <!-- RIF o Cedula de cliente -->
              
              <div class="form-group">
                {!! Form::label('RIF_CedulaCli', 'RIF ó Cedula', []) !!}
                {!! Form::text('RIF_CedulaCli', null, ['class'=>'form-control', 'placeholder'=>'Ingrese el RIF o la ceduda']) !!}
              </div>
              <!-- Direccion de Ciente -->
              
              <div class="form-group">
                {!! Form::label('direccionCli', 'Dirección', []) !!}
                {!! Form::text('direccionCli', null, ['class'=>'form-control', 'placeholder'=>'Ingrese la direccion']) !!}
              </div>
            </div>
            <!--=================================================
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
              ...
              <div class="form-group">
                ...
                {!! Form::text('telefonoCli', null, ['class'=>'form-control pull-right', 'placeholder'=>'Ingrese el Telefono']) !!}
                </div>
              </div>
              <!-- Descripcion del cliente -->
              <div class="form-group">
                {!! Form::label('descripcionCli', 'Descripción', []) !!}
                {!! Form::textarea('descripcionCli', null, ['class'=>'form-control','style'=>'resize:none', 'rows'=>'4','placeholder'=>'Ingrese la direccion']) !!}
              </div>
            </div>
        </div>
